...
namespace AutoAPP
{
    public class ThreadProcessDaHua
    {
        ...
        private string ThreadName = "Save  File For DaHua";
        private InspectConfig.ConfigData Aconfig =null;
        private string strCsvPath = string.Empty;
        ...
        public ThreadProcessDaHua(string strCsvPath )
        {
            //lin 20190813
        ...
        public void CountThreadProc()
        {
            ...
            try
            {
                AutoAPP.MainForm._runnerDaHua = this;
                if (this.running == true)
                {
                    ...
                    bp.SaveDataForZHEJIANGDAHUA( this.strCsvPath);
                }
            ...
            {
               // log.WriteLog("线程DaHua结束!", ThreadName);
            }
        }
