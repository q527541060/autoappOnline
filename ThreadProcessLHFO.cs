...
namespace AutoAPP
{
    class ThreadProcessLHFO
    {
        ...
        private string ThreadName = "Save  File For LONGHUA";
        private string _strRealConfigPath = "";

        public ThreadProcessLHFO(string AstrRealConfigPath)
        {
            //lin 20190813
        ...
        public void CountThreadProc()
        {
            ...
            try
            {
                if (this.running == true)
                {
                    ...
                    bu_Peng.SaveDataForLHfoxNG(strConnectString, strLastPcbPath, strLastPcbFile, strLastAppsettingTmpFile, strAppsettingPath, appSettingHandle, timer, _strRealConfigPath);
                }
            ...
            {
                //log.WriteLog("线程LHFOX结束!", ThreadName);
            }
        }
