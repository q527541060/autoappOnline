...
namespace AutoAPP
{
    class ThreadProcessCDFO
    {
        ...
        private string ThreadName = "Save File For CDFOX";
        private string _strRealConfigPath = "";
        private InspectConfig.ConfigData _ConfigAl;
        ...
        public void CountThreadProc()
        {
            ...
            try
            {
                ...
                {               
                    ...
                    if (!File.Exists(strLastAppsettingTmpFile))
                    {
                        ...
                        {
                            appSettingHandle.Read(zeroAPPfile, this._ConfigAl);
                        }
                    ...
                    else
                    {
                        ...
                        {
                            appSettingHandle.Read(nestAPPfile, _ConfigAl);
                        }
                        StreamWriter swAppsetting = new StreamWriter(fsAppsetting, System.Text.Encoding.Default);
                    ...
                    bu_Peng.SaveFileForCdFox(strConnectString, strLastPcbPath, strLastPcbFile, strLastAppsettingTmpFile, strAppsettingPath, appSettingHandle, timer, _ConfigAl);                    
                }
            ...
            {
                //log.WriteLog("线程CDFOX结束!", ThreadName);
            }
        }
