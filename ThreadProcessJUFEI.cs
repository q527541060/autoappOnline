...
namespace AutoAPP
{
    class ThreadProcessJUFEI
    {
        private Boolean running = false;
        private DateTime dtStartTime = new DateTime(2011, 11, 11);
        private DateTime dtEndTime = new DateTime(2011, 11, 11);
        private string strJufeiPath = string.Empty;
        //private int intSectionTime = 10;
        private Thread threadProcess;
        private static Mutex mut = new Mutex();
        private string strConnectString = string.Empty;
       
        private string ThreadName = "Save  File For Jufei";

        public ThreadProcessJUFEI(DateTime dtStartTime, DateTime dtEndTime, string AstrJufeiPath)
        {
            ...
            this.strJufeiPath = AstrJufeiPath;
        ...
        public void CountThreadProc()
        {
             ...
             try
            {
                ...
                {
                    bu_Peng.ExDataForJUFEI(this.strConnectString, strJufeiPath, dtStartTime, dtEndTime);
                }
            }
            catch (Exception ex)
            {
            ...
            {
                //log.WriteLog("线程JUFEI结束!", ThreadName);
            }
        }
